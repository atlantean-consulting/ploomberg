...
from ploomberg.screens.stash_view import StashView
from ploomberg.screens.trading_view import TradingView
...
class PloombergApp(App):
    ...
    BINDINGS = [
        ...
        Binding("f4", "switch_stash", "Stash", priority=True),
        Binding("f6", "switch_trading", "Trade", priority=True),
    ...
    def action_switch_stash(self) -> None:
        self.switch_mode("stash")
        self.call_later(self._broadcast_prices)

    def action_switch_trading(self) -> None:
        self.switch_mode("trading")
        self.call_later(self._broadcast_prices)
